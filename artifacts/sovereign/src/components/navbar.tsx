          ...
          <div className="flex-shrink-0 flex items-center gap-3">
            <Link href="/">
              <div className="flex items-center gap-3 cursor-pointer group">
                <img src={sovereignLogo} alt="Sovereign" className="w-8 h-8 object-contain transition-transform group-hover:scale-110 duration-300" />
                <span className="text-xl font-bold text-primary tracking-wide uppercase gold-glow hidden sm:block">Sovereign</span>
              </div>
            </Link>
          </div>
